                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" id="">
                            <li><a class="dropdown-item" href="<?php echo APP_URL; ?>/bitacora/index"><i class="fa-solid fa-clipboard-list me-2"></i> Bitácora</a></li>
                            <li><a class="dropdown-item" href="<?php echo APP_URL; ?>/usuarios/index"><i class="fa-solid fa-users-cog me-2"></i> Usuarios</a></li>
                            <li><a class="dropdown-item" href="<?php echo APP_URL; ?>/roles/index"><i class="fa-solid fa-key"></i> Roles-Permisos</a></li>
                            <li><a class="dropdown-item" href="<?php echo APP_URL; ?>/modulos/index"><i class="fa-solid fa-cubes"></i> Módulos</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="categoriasDropdown" role="button" data-bs-toggle="dropdown">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="<?php echo APP_URL; ?>/mantenimiento/index"><i class="fas fa-database me-2"></i> Mantenimiento</a></li> 
                            <li class="dropdown-divider"></li> 
