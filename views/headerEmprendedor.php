                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="categoriasDropdown" role="button" data-bs-toggle="dropdown">
                            <i class="fa-solid fa-ticket"></i> Ventas
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" id="">
                            <li><a class="dropdown-item" href="<?php echo APP_URL; ?>/ventaslote/index"><i class="fa-solid fa-clipboard-list me-2"></i> Por lote</a></li>
                            <li><a class="dropdown-item" href="<?php echo APP_URL; ?>/ventaspresencial/index"><i class="fa-solid fa-handshake me-2"></i> Presencial</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" id="datospago" href="<?php echo APP_URL; ?>/datos/index"><i class="fa-solid fa-money-bill"></i> Mis métodos de pago</a></li>                            
                            <li class="dropdown-divider"></li>                                                        
                            <li><a class="dropdown-item" href="<?php echo APP_URL; ?>/clientes/index"><i class="fa-solid fa-users"></i> Mis clientes</a></li>                            
                            <li class="dropdown-divider"></li>
